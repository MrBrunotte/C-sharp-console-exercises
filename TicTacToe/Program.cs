...
namespace TicTacToe
{
    internal class Program
    {
        ...
        private static int CheckWinner(char[] gameMarkers)
        {
            ...
            // 3.3 If all makers are placed and no winner then it's a draw stop the game
        ...
        private static bool IsGameWinner(char[] gameMarkers)
        {
            ...
            //if (IsGameMarkersTheSame(gameMarkers, gameMarkers[0], , gameMarkers[1], gameMarkers[2]))
            //{
            //    return 1;
            //}
            //if (IsGameMarkersTheSame(gameMarkers, gameMarkers[3], , gameMarkers[4], gameMarkers[5]))
            //{
            //    return 1;
            //}
        }
        ...
        private static void GameEngine(char[] gameMarkers, int currentPlayer)
        {
            ...
            do
            {
                    ...
                    userInput.Equals("9")))
                {
                    ...
                    {
                        Console.WriteLine("Placement has already a maker, please select another placement.");
                    }
                    else
                    {
        ...
        private static void HeadsUpDisplay(int playerNumber)
        {
            // 1. Provide information
            // 1.1 A greeting
            Console.WriteLine("Welcome to the TicTacToe game!");
            // 1.2 display player sign, Player 1 is X, Player 2 is O
        ...
        private static void DrawGameBoard(char[] gameMarkers)
        {
            ...
            // 2.1 Game will have a game board of 3 X 3 from 1-9
